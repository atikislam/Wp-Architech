...
(function($) {
    ...
    wp.customize('menu_text_color', function(value) {
        value.bind(function(newval) {
            $('.main-menu a, .main-menu .navigation a').css('color', newval);
        });
    });
    ...
    wp.customize('menu_hover_color', function(value) {
        value.bind(function(newval) {
            $('.main-menu a:hover, .main-menu .navigation a:hover').css('color', newval);
        });
    });
    ...
    wp.customize('menu_active_color', function(value) {
        value.bind(function(newval) {
            $('.main-menu .current-menu-item a, .main-menu .current-menu-item a:hover, .main-menu .current_page_item a, .main-menu .current_page_item a:hover, .main-menu .navigation .current-menu-item > a, .main-menu .navigation .current_page_item > a').css('color', newval);
        });
    });
